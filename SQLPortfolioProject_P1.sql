...
--we can show what percentage of population has covid:
...
--We can do the same but now by continent instead of country:
...
--Now lets see what we have in the other table (vaccination)
Select *
From PortfolioProject..CovidVaccinations$
